...
#define kPoint                  @"Point"
#define kClose                  @"Distance"
#define kDate                   @"TimeStamp"
#define kHigh                   @"High"
#define kLow                    @"Low"
#define kOpen                   @"Open"
#define kVolume                 @"Volume"

#define kDateFormat             @"dd/MMM/yyyy HH:mm:ss.SS"
...
//                CGContextRestoreGState(context);
                ...
                [[NSString stringWithFormat:@"%d:%d:%d",[components hour],[components minute], [components second]] drawAtPoint:CGPointMake(i-10, kTopMargin + self.chartHeight + 10) withFont:kStatesticFont];
                CGContextStrokePath(context);
            }
            ...
            [[NSString stringWithFormat:@"%d:%d:%d",[components hour],[components minute], [components second]] drawAtPoint:CGPointMake(kTopMargin + self.chartWidth-10, kTopMargin + self.chartHeight + 10) withFont:kStatesticFont];
