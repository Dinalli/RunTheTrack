...
-(void)composePost:(NSString *)serviceType
{
    ...
    [composeSheet setInitialText:[NSString stringWithFormat:@"Comepleted a run round the %@ GP track. Time %@ %@ %@", self.navigationItem.title, [self.timeLabel getValueString], runDistance.text, runLaps.text]];
