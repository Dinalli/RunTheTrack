...
-(void)composePost:(NSString *)serviceType
{
    ...
    [composeSheet setInitialText:[NSString stringWithFormat:@"Just comepleted a run round the %@ GP track. %@ %@", self.navigationItem.title, runTime.text, runDistance.text]];
